...
> 成员页原文标签为 "Current Students / PhDs"。页面仅公开英文名，按本库规则不为无法消歧的英文名建独立页，保留原文写法待补中文名。

| 姓名（页面原文） | 页面标签 | 来源 |
|---|---|---|
| Taijie Chen | Current Students / PhDs | S7、S8 |
| Yujun Liang | Current Students / PhDs | S7、S8 |
| Chaofan Lin | Current Students / PhDs | S7、S8 |
| Hongren Zheng | Current Students / PhDs | S7、S8 |
| Yongqi Zhuo | Current Students / PhDs | S7、S8 |

## 不纳入成员表的线索

| 姓名（页面原文） | 页面标签 | 不纳入原因 |
|---|---|---|
| Jiangbin Dong | Current Students / PhDs | 页面明示为与西安交通大学联合指导，无法据此确认为 IIIS 在读博士 |
...
- [ ] 5 位在读博士生的中文名、论文一作情况与实习/就业去向。
- [ ] 三位联合指导 PhD 的学籍归属与清华/IIIS 关系。
- [ ] 高鸣宇是否有工商登记的公司关系或技术授权/成果转化记录。
