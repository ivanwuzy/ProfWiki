...
> 课题组页原文标签为"在读博士生"。9 人均未单独建页（未过人物页硬门槛），学生个人信号后续从论文作者与开源提交记录补证。
...
| 项目 | 内容 | 发表 |
|---|---|---|
| CARMI | 缓存感知学习型索引 | VLDB'22 |
| Blitzcrank | 内存 OLTP 数据库压缩 | VLDB'24 |
| Robust Predicate Transfer | "Debunking the Myth of Join Ordering" | SIGMOD'25 |
| 向量化执行数据块压实 | 向量化执行引擎优化 | SIGMOD'25 |

## 创业/产业化线索

| 公司/项目 | 关联方式 | 相关人物 | 证据 |
|---|---|---|---|
| 待验证 | 未检索到张焕晨或 Embryo Labs 的公司化/融资公开证据 | — | — |
| 国产数据库生态 | 张焕晨面向国内数据库社区做过技术分享（如"Gauss 松鼠会"讲座《迈向成本智能的云数据仓库》） | 张焕晨 | 公开讲座记录 |

## 待验证

- [ ] 9 位在读博士生的论文一作情况与毕业去向。
- [ ] 开源项目是否有企业采用或商业化迹象。
- [ ] 与国产数据库厂商（如华为 GaussDB 生态）是否存在稳定合作或人才通道。
