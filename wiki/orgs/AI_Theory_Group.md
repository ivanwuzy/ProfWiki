...
> 成员页原文标签为 "PhD students"。成员页仅公开英文名；陈乐偲已通过本人及IIIS页面完成中英文消歧并建页，其余尚不能消歧者保留英文原文待核。
>
> 来源等级说明：成员页 S10 由 IIIS 官网 S9 直接链接，但页面本身托管在 Google Sites，属 `single_source`。

| 姓名（页面原文） | 页面标签 | 来源 |
|---|---|---|
| Jingwei Li | PhD students | S9、S10 |
| Lesi Chen | PhD students | S9、S10 |
| Bei Luo | PhD students | S9、S10 |
| Hongyi Zhou | PhD students | S9、S10 |
| Jiazheng Li | PhD students | S9、S10 |

## 关键产出

| 类型 | 内容 | 年份 |
|---|---|---:|
| 奖项 | 组内研究团队获 COLT 2025 最佳学生论文奖，工作为 "Solving Convex-Concave Problems with O(ε^-4/7) Second-Order Oracle Complexity" | 2025 |
| 论文 | Bilevel 优化中超目标（hyper-objective）理论性质（COLT 2024） | 2024 |
| 论文 | 两阶段 scaling law（two-phase scaling law） | 2023 |
| 论文 | 锂电池故障检测的动态深度学习（Nature Communications） | 2023 |
| 社区 | 组织 ICLR 2024 "Bridging the Gap between Theory and Practice for Learning" workshop | 2024 |

## 创业/产业化线索

| 公司/项目 | 关联方式 | 相关人物 | 证据 |
|---|---|---|---|
| 待验证 | 未检索到张景昭或本组的公司化公开证据 | — | — |
| 电池/工业异常检测 | 锂电池故障检测工作（Nature Communications 2023）显示理论方法有工业落地路径 | 张景昭及学生 | 论文记录 |

## 待验证

- [ ] 成员中文名；其中陈乐偲已完成中英文消歧及COLT 2025第一作者核验，其余成员仍待核。
- [ ] 锂电池故障检测工作是否有企业合作方或成果转化。
- [ ] 组内学生毕业去向（学术 vs 产业）。
