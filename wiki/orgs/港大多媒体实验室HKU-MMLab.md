...
具身、多模态与生成式AI的重要人才网络，采用多PI组织形态；与港中大MMLab分别建页。

## 基本信息

| 字段 | 内容 |
|---|---|
| 所属单位 | 香港大学；官网成员横跨计算机、ECE及IDS。单一行政上级待验证，导航暂挂高校；[归属与状态待核](../questions/香港具身实验室归属与创业状态待核.md)。 |
| 当前运行 | 以成员当前在岗、刘希慧主页列出的2026研究成果与公开招聘支持“持续活跃”；不以域名在线单独判断。 |
| 名称边界 | 官网沿用汤晓鸥创立MMLab的学术谱系介绍，不据此把港大团队的成立时间写成2001年。 |
...
李弘扬的[源策未来](../companies/源策未来ArchonRobotics.md)为已建公司关系，详见其个人与公司页。其他成员的产业经历不等同于创办公司；本次没有证据把所有公司认定为HKU-MMLab官方孵化。

## 下属实验室/课题组

目前未建以本网络为确定行政父节点的下属页。
