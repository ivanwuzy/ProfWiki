...
Yixin Zhu
Assistant Professor
PKU School of Psychological and Cognitive Sciences
PKU Institute for AI
Biography
Dr. Yixin Zhu received a Ph.D. degree (‘18) from UCLA advised by Prof.
Song-Chun Zhu
.
His research builds interactive AI by integrating high-level common sense (
functionality
,
affordance
,
...
,
intent
) with raw sensory inputs (pixels and haptic signals) to enable richer representation and cognitive reasoning on objects, scenes, shapes, numbers, and agents.
Dr. Zhu directs the PKU
CoRe Lab
, working on abstract reasoning, visually grounded reasoning, and interactive reasoning.
[CV]
[Dissertation]
Getting Started
帮你自学大学四年AI的所有内容
...
汇集官方和权威渠道对通班的报道
博雅一号（成都）
目前仅限AI院全职PI和北大通班学生使用
Actively looking for
PostDocs on a rolling basis
. We offer competitive benefits and a first-class platform. 北京大学博士后项目的更多信息请参见
这里
.
Topics
Active Learning
...
[EMNLP26] Inferring the Unspoken: Aligning Embodied Agents with Implicit Preferences
Manjie Xu
,
Xinyi Yang
,
...
Video
Web
[TPAMI26] AffordX: Generalizable and Slim Affordance Reasoning for Task-oriented Manipulation
Xiaomeng Zhu
,
Yuyang Li
,
...
Supp
Web
[RA-L26] Simultaneous Tactile-Visual Perception for Learning Multimodal Robot Manipulation
Yuyang Li
,
Yinghan Chen
,
